[![Run App Armone Dean ](https://github.com/ATdean19/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/ATdean19/GithubActions/actions/workflows/run-app.yaml)
